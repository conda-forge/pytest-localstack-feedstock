...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-localstack-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-localstack-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pytest-localstack
# for installing globally
pixi global install pytest-localstack
```
...
It is possible to list all of the versions of `pytest-localstack` available on your platform:
...
```
pixi search pytest-localstack --channel conda-forge
```
